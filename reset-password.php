                        ...
                        <div class="p-3">
                            <form class="form-horizontal mt-3" method="POST" autocomplete="off" action="action.php">
                                <div style="display:none;" class="row mb-3">
                                    <div class="col-12">
                                        <select name="action_user_type" id="action_user_type" class="form-control">
                                ...
                                <div class="form-group mb-3 row">
                                    <div class="col-12">
                                        ...
                                        <input class="form-control" name="action" id="action" type="hidden" value="forgot_password" required placeholder="E-mail">
                                    </div>
                                </div>
                                <div class="form-group mb-3 text-center row mt-3 pt-1">
                                    <div class="col-12">
                                        <button class="btn btn-info w-100 waves-effect waves-light" type="submit">Gete Code</button>
                                    </div>
                                </div>
