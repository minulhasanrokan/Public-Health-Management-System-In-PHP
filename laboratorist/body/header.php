...
if(!isset($_SESSION['laboratoristStatus'])){
...
if(isset($_GET['status']) && $_GET['status']=='logout'){
    ...
    $status = $login->add_logout_history(5,$user_id);
...
$laboratorist_data = $laboratorist->get_single_laboratorist($user_id);
                ...
                <div class="navbar-header">
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box">
                            <a href="<?php echo BASEPATH; ?>/laboratorist" class="logo logo-dark">
                                <span class="logo-sm">
                            ...
                            <a href="<?php echo BASEPATH; ?>/laboratorist" class="logo logo-light">
                                <span class="logo-sm">
                    ...
                    <div class="d-flex">
                        ...
                        <div class="dropdown d-inline-block user-dropdown">
                            <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                                data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img class="rounded-circle header-profile-user" src="<?php echo BASEPATH; ?>/uploads/laboratorist/<?php if($laboratorist_data['image']!=''){ echo $laboratorist_data['image']; } else{ echo "avatar.jpg";}?>"
                                    alt="<?php echo $laboratorist_data['name'];?>">
                                <span class="d-none d-xl-inline-block ms-1"><?php echo $laboratorist_data['name'];?></span>
                                <i class="mdi mdi-chevron-down d-none d-xl-inline-block"></i>
                            </button>
                            <div class="dropdown-menu dropdown-menu-end">
                                <!-- item-->
                                <a class="dropdown-item" href="<?php echo BASEPATH;?>/laboratorist/profile"><i class="ri-user-line align-middle me-1"></i>Profile</a>
                                <a class="dropdown-item d-block" href="<?php echo BASEPATH;?>/laboratorist/change-password"><i class="mdi mdi-onepassword align-middle me-1"></i>Change Password</a>
