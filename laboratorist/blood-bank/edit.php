                ...
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <div class="page-title-left">
                            ...
                            <a href="<?php echo BASEPATH?>/laboratorist/blood-bank/add" style="margin-left: 10px;" class="btn btn-info">Add Blood Group</a>
                            <a href="<?php echo BASEPATH?>/laboratorist/blood-bank/action?id=<?php echo $single_blood_group['blood_group_id'];?>&action=view_blood_group" style="margin-left: 10px;" class="btn btn-info">View Blood Group</a>
                        </div>
