...
<?php
	...
	$all_appointment = $appointment ->get_all_appointment_for_add_report($ofset=null, $limit=null,$appointment_id=null, $doctor_id=null,$nurse_id=null,$patient_id=null,$shedule_id=null,$accept_status=1,$date_con=null,$doctor_comment=1,$report_status='0');
?>
                        	...
                        	?>
		                            <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
		                                ...
		                                <tr>
		                                    ...
		                                    <td align="center">
		                                    	<a href="<?php echo BASEPATH;?>/laboratorist/report/action?id=<?php echo $appointment['appointment_id'];?>&action=add_report_details" class="btn btn-primary btn-icon mg-r-5 mg-b-10">Add Report</a>
		                                    </td>
		                                </tr>
		                                <?php
		                                		$i++;
