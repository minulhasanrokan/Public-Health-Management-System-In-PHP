        ...
        <div class="container-fluid">
                ...
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <div class="page-title-left">
                            <a href="<?php echo BASEPATH?>/laboratorist/profile" style="margin-left: 10px;" class="btn btn-info">View Profile </a>
                        </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <form method="POST" action="<?php echo BASEPATH?>/laboratorist/action" enctype="multipart/form-data">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <input class="form-control" name="laboratorist_id" id="laboratorist_id" type="hidden" value="">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" name="email" id="email" type="text" placeholder="Enter Pharmacist Email" required value="<?php echo $single_laboratorist['email'];?>">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="example-text-input" class="col-sm-2 col-form-label">Pharmacist Address</label>
                                    <div class="col-sm-10">
                                        <textarea class="form-control" name="address" id="address" placeholder="Enter Pharmacist Address" required><?php echo $single_laboratorist['address'];?></textarea>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="example-text-input" class="col-sm-2 col-form-label">Pharmacist Description</label>
                                    <div class="col-sm-10">
                                        <textarea class="form-control" name="description" id="description" placeholder="Enter Pharmacist Description" required><?php echo $single_laboratorist['description'];?></textarea>
                                    </div>
                                </div>
                                <div class="row mb-3">
