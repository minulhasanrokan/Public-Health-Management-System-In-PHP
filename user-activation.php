...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Acctount Activation - <?php echo $system_data['title'];?></title>
            ...
            <div class="container-fluid p-0">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="text-muted text-center font-size-18"><b>Acctount Activation</b></h4>
                        <div class="p-3">
                            <form class="form-horizontal mt-3" method="POST" autocomplete="off" action="action.php">
                                ...
                                <div class="form-group mb-3 row">
                                    <div class="col-12">
                                        ...
                                        <input class="form-control" name="action" id="action" type="hidden" value="account_activation" required>
                                ...
                                <div class="form-group mb-3 text-center row mt-3 pt-1">
                                    <div class="col-12">
                                        <button class="btn btn-info w-100 waves-effect waves-light" type="submit">Active Acctount</button>
                                    </div>
                                </div>
