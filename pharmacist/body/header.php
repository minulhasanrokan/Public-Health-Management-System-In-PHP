...
if(!isset($_SESSION['pharmacistStatus'])){
...
if(isset($_GET['status']) && $_GET['status']=='logout'){
    ...
    $status = $login->add_logout_history(4,$user_id);
...
$pharmacist_data = $pharmacist->get_single_pharmacist($user_id);
                ...
                <div class="navbar-header">
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box">
                            <a href="<?php echo BASEPATH; ?>/pharmacist" class="logo logo-dark">
                                <span class="logo-sm">
                            ...
                            <a href="<?php echo BASEPATH; ?>/pharmacist" class="logo logo-light">
                                <span class="logo-sm">
                    ...
                    <div class="d-flex">
                        ...
                        <div class="dropdown d-inline-block user-dropdown">
                            <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                                data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img class="rounded-circle header-profile-user" src="<?php echo BASEPATH; ?>/uploads/pharmacist/<?php if($pharmacist_data['image']!=''){ echo $pharmacist_data['image']; } else{ echo "avatar.jpg";}?>"
                                    alt="<?php echo $pharmacist_data['name'];?>">
                                <span class="d-none d-xl-inline-block ms-1"><?php echo $pharmacist_data['name'];?></span>
                                <i class="mdi mdi-chevron-down d-none d-xl-inline-block"></i>
                            </button>
                            <div class="dropdown-menu dropdown-menu-end">
                                <!-- item-->
                                <a class="dropdown-item" href="<?php echo BASEPATH;?>/pharmacist/profile"><i class="ri-user-line align-middle me-1"></i> Profile</a>
                                <a class="dropdown-item d-block" href="<?php echo BASEPATH;?>/pharmacist/change-password"><i class="mdi mdi-onepassword align-middle me-1"></i>Change Password</a>
