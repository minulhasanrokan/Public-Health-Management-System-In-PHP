                ...
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <div class="page-title-left">
                            ...
                            <a href="<?php echo BASEPATH?>/pharmacist/medicine/action?id=<?php echo $single_medicine['medicine_id'];?>&action=view_medicine" style="margin-left: 10px;" class="btn btn-info">View Medicine </a>
                        </div>
