                ...
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <div class="page-title-left">
                            <a href="<?php echo BASEPATH?>/pharmacist/medicine/all-medicine" class="btn btn-info">All Medicine</a>&nbsp;
                            <a href="<?php echo BASEPATH?>/pharmacist/medicine/add-medicine" style="margin-left: 10px;" class="btn btn-info">Add Medicine</a>
                            <a href="<?php echo BASEPATH?>/pharmacist/medicine/action?id=<?php echo $single_medicine['medicine_id'];?>&action=edit_medicine" style="margin-left: 10px;" class="btn btn-info">Edit Medicine</a>
                        </div>
                    ...
                    <div class="card-group">
                        <div class="card mb-12">
                            ...
                            <div class="card-body">
                                ...
                                <h4 class="card-text">Category Name :<a href="<?php echo BASEPATH;?>/pharmacist/medicine/action?id=<?php echo $single_medicine['category_id'];?>&action=view_medicine_category"><?php echo $single_medicine['category_name'];?></a></h4>
