		                            ...
		                            <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
		                                ...
		                                <?php
		                                	...
		                                	foreach($all_appointment as $appointment){
		                                		...
		                                		if($appointment['complete_status']==0)
		                                		{
		                                ...
		                                <tr>
		                                    ...
		                                    <td align="center">
		                                    	<a href="<?php echo BASEPATH;?>/doctor/appointment/action?id=<?php echo $appointment['appointment_id'];?>&action=view_appointment" class="btn btn-primary btn-icon mg-r-5 mg-b-10"><i class="mdi mdi-monitor-eye"></i></a>
		                                    </td>
		                                </tr>
		                                <?php
		                                			$i++;
