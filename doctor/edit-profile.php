        ...
        <div class="container-fluid">
                ...
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <div class="page-title-left">
                            <a href="<?php echo BASEPATH?>/doctor/action?action=view_profile" style="margin-left: 10px;" class="btn btn-info">View Profile </a>
                        </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <form method="POST" action="<?php echo BASEPATH?>/doctor/action" enctype="multipart/form-data">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <input class="form-control" name="doctor_id" id="doctor_id" type="hidden" placeholder="Enter Doctor Name" required value="">
                                ...
                                <input class="form-control" name="edit_request" id="edit_request" type="hidden" value="edit_request">
