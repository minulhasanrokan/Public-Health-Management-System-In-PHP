...
<?php
    ...
    if($single_nurse==''){
        ...
        ?>
            <script>window.location="<?php echo BASEPATH."/doctor/nurse/404"; ?>";</script>
        <?php
    }
    else{
                    ...
                    <div class="card-group">
                        <div class="card mb-12">
                            <div class="card-body">
                                ...
                                <h4 class="card-text">Doctor Name: <a href="<?php echo BASEPATH; ?>/doctor/action?id=<?php echo $single_nurse['doctor_id']; ?>&action=view_doctor"><?php echo $single_nurse['doctor_name']; ?></a></h4>
