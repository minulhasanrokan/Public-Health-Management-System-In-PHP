            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="card-group">
                        <div class="card mb-12">
                            <div class="card-body">
                                <h3 class="card-text"><a href="<?php echo BASEPATH;?>/patient/doctor/action?id=<?php echo $single_doctor['doctor_id'];?>&action=view_doctor" style="text-decoration: none;">Doctor Name: <?php echo $single_doctor['name']; ?></a></h3>
