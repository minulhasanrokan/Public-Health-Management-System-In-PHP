...
<?php
	...
	$all_appointment = $appointment ->next_visit_date_appointment($ofset=null, $limit=null,$appointment_id=null, $doctor_id=null,$nurse_id=null,$id,$shedule_id=null,$accept_status=1,$date_con=0,$next_visit_date=1);
?>
                        	...
                        	?>
		                            <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
		                                ...
		                                <tr>
		                                    ...
		                                    <td align="center">
		                                    	<a href="<?php echo BASEPATH;?>/patient/appointment/action?id=<?php echo $appointment['appointment_id'];?>&action=view_appointment" class="btn btn-info btn-icon mg-r-5 mg-b-10"><i class="mdi mdi-monitor-eye"></i></a>
		                                    </td>
		                                </tr>
		                                <?php
		                                			$i++;
