...
?>
<title><?php echo $system_data_title;?> Add Appointment Details</title>
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <a href="<?php echo BASEPATH?>/patient/doctor/action?action=view_shedule&id=<?php echo $single_shedule['doctor_id']; ?>" class="btn btn-info">All Shedule</a>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <form method="POST" action="<?php echo BASEPATH?>/patient/doctor/action" enctype="multipart/form-data">
                                <div class="row mb-3">
                                    <label for="example-text-input" class="col-sm-2 col-form-label">Patient Name</label>
                                    <div class="col-sm-10">
                                        <input readonly class="form-control" name="shedule_date" id="shedule_date" type="text" placeholder="Patient Name" required value="<?php echo $patient_data['name']; ?>">
                                        <input readonly class="form-control" name="patient_id" id="patient_id" type="hidden" required value="<?php echo $patient_data['patient_id']; ?>">
                                    </div>
                                </div>
                                <div class="row mb-3">
