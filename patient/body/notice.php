<?php
    ...
    $all_notice = $notice->get_all_notice($ofset, $limit,$notice_for=1,$user_id=null,$notice_date=null,$published_date=null);

    $number_of_notice = $notice->number_of_notice($notice_for=1,$user_id=null,$notice_date=null,$published_date=null);
