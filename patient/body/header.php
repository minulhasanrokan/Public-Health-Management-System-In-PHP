...
if(!isset($_SESSION['patientStatus'])){
...
if(isset($_GET['status']) && $_GET['status']=='logout'){
    ...
    $status = $login->add_logout_history(7,$user_id);
...
$patient_data = $patient->get_single_patient($user_id);
                ...
                <div class="navbar-header">
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box">
                            <a href="<?php echo BASEPATH; ?>/patient" class="logo logo-dark">
                                <span class="logo-sm">
                            ...
                            <a href="<?php echo BASEPATH; ?>/patient" class="logo logo-light">
                                <span class="logo-sm">
                    ...
                    <div class="d-flex">
                        ...
                        <div class="dropdown d-inline-block user-dropdown">
                            <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                                data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img class="rounded-circle header-profile-user" src="<?php echo BASEPATH; ?>/uploads/patient/<?php if($patient_data['image']!=''){ echo $patient_data['image']; } else{ echo "avatar.jpg";}?>"
                                    alt="<?php if($patient_data['name']!=''){ echo $patient_data['name']; }else{ echo "User Name"; }?>">
                                <span class="d-none d-xl-inline-block ms-1"><?php if($patient_data['name']!=''){ echo $patient_data['name']; }else{ echo "User Name"; }?></span>
                                <i class="mdi mdi-chevron-down d-none d-xl-inline-block"></i>
                            </button>
                            <div class="dropdown-menu dropdown-menu-end">
                                <!-- item-->
                                <a class="dropdown-item" href="<?php echo BASEPATH;?>/patient/profile"><i class="ri-user-line align-middle me-1"></i> Profile</a>
                                <a class="dropdown-item d-block" href="<?php echo BASEPATH;?>/patient/change-password"><i class="mdi mdi-onepassword align-middle me-1"></i>Change Password</a>
