                ...
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                         <div class="page-title-left">
                            ...
                            <a href="<?php echo BASEPATH?>/nurse/floor/action?id=<?php echo $single_floor['floor_id'];?>&action=view_floor" style="margin-left: 10px;" class="btn btn-info">View Doctor </a>
                        </div>
