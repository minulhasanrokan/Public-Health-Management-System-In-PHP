            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    	<!--<a href="<?php echo BASEPATH?>/admin/bill/appointment-bill-add" class="btn btn-info">Add Bill </a>-->
                        &nbsp;
                        	...
                        	?>
		                            <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
		                                ...
		                                <tr>
		                                    ...
		                                    <td align="center">
		                                    	<a href="<?php echo BASEPATH;?>/admin/bill/action?id=<?php echo $bill['bill_id'];?>&action=print_bill" class="btn btn-info btn-icon mg-r-5 mg-b-10">Print Bill</a>
		                                    </td>
		                                </tr>
		                                <?php
		                                		$i++;
