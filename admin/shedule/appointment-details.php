...
?>
<title><?php echo $system_data_title;?> View Appointment Details - <?php echo $single_doctor['appointment_number']; ?></title>
                ...
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <div class="page-title-left">
                            <a href="<?php echo BASEPATH?>/admin/appointment/all" class="btn btn-info">All Appointment </a>&nbsp;
                            <a href="<?php echo BASEPATH?>/admin/appointment/add" style="margin-left: 10px;" class="btn btn-info">Add Appointment</a>
                            <?php if($single_appointment['accept_status']==0){ ?>
                            <a href="<?php echo BASEPATH;?>/admin/appointment/action?id=<?php echo $single_appointment['appointment_id'];?>&action=accept_appointment" class="btn btn-info btn-icon mg-r-5 mg-b-10"><i class="mdi mdi-check"></i></a>
                            <a href="<?php echo BASEPATH;?>/admin/appointment/action?id=<?php echo $single_appointment['appointment_id'];?>&action=reject_appointment" class="btn btn-danger btn-icon mg-r-5 mg-b-10"><i class="mdi mdi-delete"></i></a>
                        <?php }?>
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="card-group">
                        <div class="card mb-12">
                            <div class="card-body">
                                <h3 class="card-text"><a href="<?php echo BASEPATH;?>/admin/doctor/action?id=<?php echo $single_doctor['doctor_id'];?>&action=view_doctor" style="text-decoration: none;">Doctor Name: <?php echo $single_doctor['name']; ?></a></h3>
