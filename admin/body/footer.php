        ...
        if(isset($chart_data_display) && $chart_data_display==1){
            ...
            $admit = new Admit();
            $number_of_admit_month_curr_year = $admit->number_of_admit_month_curr_year($doctor_id=null,$nurse_id=null,$year=null);
        ...
        ?>
            <script type="text/javascript">
                var options={
                    ...
                    yaxis:{labels:{formatter:function(e){return e.toFixed()+" Pataint"}},tickAmount:10,min:0,max:<?php echo number_format($max_value+10);?>},
        ...
        <script type="text/javascript">
                var options={
                    ...
                    {toolbar:{show:!1},height:350,type:"area"},
                    dataLabels:{enabled:!1},
                    yaxis:{labels:{formatter:function(e){return e.toFixed()+" Taka"}},tickAmount:10,min:0,max:<?php echo $max_value+10;?>},
                    stroke:{curve:"smooth",width:2},
                    grid:{show:!0,borderColor:"#90A4AE",strokeDashArray:0,position:"back",xaxis:{lines:{show:!0}},yaxis:{lines:{show:!0}},row:{colors:void 0,opacity:.8},column:{colors:void 0,opacity:.8},padding:{top:10,right:0,bottom:10,left:10}},
                    legend:{show:!1},
