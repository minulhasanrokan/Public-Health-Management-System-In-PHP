...
?>
<title><?php echo $system_data_title;?> Edit Nurse Details - <?php echo $single_nurse['name'];?></title>
                ...
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <div class="page-title-left">
                            ...
                            <a href="<?php echo BASEPATH?>/admin/nurse/action?id=<?php echo $single_nurse['nurse_id'];?>&action=view_nurse" style="margin-left: 10px;" class="btn btn-info">View Nurse </a>
                        </div>
                            ...
                            <form method="POST" action="<?php echo BASEPATH?>/admin/nurse/action" enctype="multipart/form-data">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <input class="form-control" name="nurse_id" id="nurse_id" type="hidden" placeholder="Enter Doctor Name" required value="<?php echo $single_nurse['nurse_id'];?>">
                                ...
                                <input style="float: right;" type="submit" value="Update Nurse" class="btn btn-info">
                            </form>
                        </div>
                    </div>
                </div> <!-- end col -->
