...
<?php
    ...
    if($single_blood_group==''){
        ...
        ?>
            <script>window.location="<?php echo BASEPATH."/admin/blood-bank/404"; ?>";</script>
        <?php
    }
    else{
        ...
        <div class="container-fluid">
                ...
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <div class="page-title-left">
                            <a href="<?php echo BASEPATH?>/admin/blood-bank/all" class="btn btn-info">All Blood Group </a>
                            <a href="<?php echo BASEPATH?>/admin/blood-bank/add" style="margin-left: 10px;" class="btn btn-info">Add Blood Group</a>
                            <a href="<?php echo BASEPATH?>/admin/blood-bank/action?id=<?php echo $single_blood_group['blood_group_id'];?>&action=view_blood_group" style="margin-left: 10px;" class="btn btn-info">View Blood Group</a>
                        </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <form method="POST" action="<?php echo BASEPATH?>/admin/blood-bank/action" enctype="multipart/form-data">
                                <div class="row mb-3">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea class="form-control" name="address" id="address" placeholder="Enter admin Address" required><?php echo $single_blood_group['address']; ?></textarea>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="example-text-input" class="col-sm-2 col-form-label">Description</label>
                                    <div class="col-sm-10">
                                        <textarea class="form-control" name="description" id="description" placeholder="Enter admin Description" required><?php echo $single_blood_group['description']; ?></textarea>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    ...
                                    alt="<?php echo $single_blood_group['name']; ?>" width="100" id="photo"/>
                                        <input onchange="readUrl(this);" accept="image/*" class="form-control" name="image" id="image" type="file" placeholder="Upload admin Photo">
                                    </div>
                                </div>
