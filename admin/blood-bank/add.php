                        ...
                        <div class="card-body">
                            <form method="POST" action="<?php echo BASEPATH?>/admin/blood-bank/action" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea class="form-control" name="address" id="address" placeholder="Enter admin Address" required></textarea>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="example-text-input" class="col-sm-2 col-form-label">Description</label>
                                    <div class="col-sm-10">
                                        <textarea class="form-control" name="description" id="description" placeholder="Enter admin Description" required></textarea>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    ...
                                    alt="admin Photo" width="100" id="photo"/>
