                ...
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <div class="page-title-left">
                            <a href="<?php echo BASEPATH?>/admin/blood-bank/action?action=edit_blood_group&id=<?php echo $single_blood_group['blood_group_id']; ?>" style="margin-left: 10px;" class="btn btn-info">Edit Blood Group </a>
                        </div>
