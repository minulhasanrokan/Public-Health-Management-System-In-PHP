                ...
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <div class="page-title-left">
                            ...
                            <a href="<?php echo BASEPATH?>/admin/medicine/add-category" style="margin-left: 10px;" class="btn btn-info">Add Medicine Category </a>
                            <a href="<?php echo BASEPATH?>/admin/medicine/action?id=<?php echo $single_category['category_id'];?>&action=view_medicine_category" style="margin-left: 10px;" class="btn btn-info">View Medicine Category </a>
                        </div>
