                ...
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <div class="page-title-left">
                            ...
                            <a href="<?php echo BASEPATH?>/admin/medicine/action?id=<?php echo $single_category['category_id'];?>&action=edit_medicine_category" style="margin-left: 10px;" class="btn btn-info">Edit Medicine Category </a>
                        </div>
