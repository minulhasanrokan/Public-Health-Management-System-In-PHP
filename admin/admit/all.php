...
<?php
	...
	$all_admit = $admit ->get_all_admit($ofset=null, $limit=null,$appointment_id=null, $doctor_id=null,$nurse_id=null,$patient_id=null,$release_satus=0,$start_date=null,$end_date=null);
?>
                        	...
                        	?>
		                            <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
		                                ...
		                                <tr>
		                                    ...
		                                    <td align="center">
		                                    	<a href="<?php echo BASEPATH;?>/admin/admit/action?id=<?php echo $admit['admit_id'];?>&action=admit_details" class="btn btn-primary btn-icon mg-r-5 mg-b-10"><i class="mdi mdi-monitor-eye"></i></a>
		                                    </td>
		                                </tr>
		                                <?php
		                                		$i++;
