...
<?php
    ...
    if($single_test==''){
        ...
        ?>
            <script>window.location="<?php echo BASEPATH."/admin/test-type/404"; ?>";</script>
        <?php
    }
    else{
                ...
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <div class="page-title-left">
                            ...
                            <a href="<?php echo BASEPATH?>/admin/test-type/add" style="margin-left: 10px;" class="btn btn-info">Add Test Type </a>
                            <a href="<?php echo BASEPATH?>/admin/test-type/action?id=<?php echo $single_test['test_id'];?>&action=view_test_type" style="margin-left: 10px;" class="btn btn-info">View Test Type </a>
                        </div>
