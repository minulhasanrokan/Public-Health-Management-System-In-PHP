                ...
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <div class="page-title-left">
                            ...
                            <a href="<?php echo BASEPATH?>/admin/test-type/action?id=<?php echo $single_test['test_id'];?>&action=edit_test" style="margin-left: 10px;" class="btn btn-info">Edit Test Type </a>
                        </div>
