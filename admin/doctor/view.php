                ...
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <div class="page-title-left">
                            ...
                            <a href="<?php echo BASEPATH?>/admin/doctor/action?id=<?php echo $single_doctor['doctor_id'];?>&action=edit_doctor" style="margin-left: 10px;" class="btn btn-info">Edit Doctor </a>
                        </div>
