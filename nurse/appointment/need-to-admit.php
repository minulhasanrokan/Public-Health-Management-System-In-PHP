...
<?php
	...
	$all_appointment = $appointment ->get_all_appointment_request($ofset=null, $limit=null,$appointment_id=null, $doctor_id=null,$nurse_id=$id,$patient_id=null,$shedule_id=null,$accept_status=1,$date_con=1,$need_to_admit=1,$admit_id=0);
?>
                        	...
                        	?>
		                            <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
		                                ...
		                                <tr>
		                                    ...
		                                    <td align="center">
		                                    	<a href="<?php echo BASEPATH;?>/nurse/appointment/action?id=<?php echo $appointment['appointment_id'];?>&action=add_admit" class="btn btn-primary btn-icon mg-r-5 mg-b-10">Admit</a>
		                                    </td>
		                                </tr>
		                                <?php
		                                		$i++;
