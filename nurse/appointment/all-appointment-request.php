...
<?php
	...
	$all_appointment = $appointment ->get_all_appointment_request($ofset=null, $limit=null,$appointment_id=null, $doctor_id=null,$nurse_id=$id,$patient_id=null,$shedule_id=null,$accept_status=0,$date_con=1);
?>
                    ...
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="<?php echo BASEPATH;?>/nursenurse">Dashboard</a></li>
                        	...
                        	?>
		                            <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
		                                ...
		                                <tr>
		                                    ...
		                                    <td align="center">
		                                    	<a href="<?php echo BASEPATH;?>/nurse/shedule/action?id=<?php echo $appointment['appointment_id'];?>&action=appointment_details" class="btn btn-primary btn-icon mg-r-5 mg-b-10"><i class="mdi mdi-monitor-eye"></i></a>
		                                    	<a href="<?php echo BASEPATH;?>/nurse/appointment/action?id=<?php echo $appointment['appointment_id'];?>&action=accept_appointment" class="btn btn-info btn-icon mg-r-5 mg-b-10"><i class="mdi mdi-check"></i></a>
		                                    	<a href="<?php echo BASEPATH;?>/nurse/appointment/action?id=<?php echo $appointment['appointment_id'];?>&action=reject_appointment" class="btn btn-danger btn-icon mg-r-5 mg-b-10"><i class="mdi mdi-delete"></i></a>
		                                    </td>
		                                </tr>
		                                <?php
		                                		$i++;
