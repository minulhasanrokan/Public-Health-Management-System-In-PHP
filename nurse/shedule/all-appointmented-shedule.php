...
<?php
	...
	$all_shedule = $shedule ->get_all_shedule($ofset=null, $limit=null,$doctor_id=null,$nurse_id=$id,$appointment_id=null,$appointment_status=1);
?>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <a href="<?php echo BASEPATH?>/nurse/shedule/add" class="btn btn-info">Add Shedule </a>
                        	...
                        	?>
		                            <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
		                                ...
		                                <tr>
		                                    ...
		                                    <td><?php if( $shedule['appointment_id']!=null || $shedule['appointment_id']!=''){ ?> <a href="<?php echo BASEPATH;?>/nurse/shedule/action?id=<?php echo $shedule['appointment_id'];?>&action=appointment_details" class="btn btn-info btn-icon mg-r-5 mg-b-10">View Details</a> <?php } ?></td>
		                                </tr>
		                                <?php
		                                		$i++;
			                        		}
